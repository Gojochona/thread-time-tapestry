...
const routeApi = getRouteApi("/_dashboard/dashboard/orders/$orderId/fabric");
  ...
  return (
    <div className="mx-auto max-w-xl">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display text-lg font-semibold">Fabric confirmation</h1>
      </div>

      <div className="mt-10 px-2">
        <p className="text-sm font-medium">Please note the following:</p>
        <ul className="mt-3 space-y-2 text-sm text-destructive">
          <li className="flex gap-2"><span>•</span><span>Do not confirm you've sent fabrics if you haven't</span></li>
          <li className="flex gap-2"><span>•</span><span>Once you have confirmed fabric dispatch, the tailor will need to acknowledge the delivery</span></li>
          <li className="flex gap-2"><span>•</span><span>Once delivery is acknowledged, work will start</span></li>
        </ul>
        ...
        {done && (
          <div className="fixed inset-0 z-[110] flex items-end justify-center sm:items-center sm:p-4">
            ...
            >
              ...
              <h3 className="mt-4 font-display text-xl font-bold">Fabric sent</h3>
              <p className="mt-1 text-sm text-muted-foreground">Awaiting tailor's acknowledgement</p>
              <button
                onClick={() => navigate({ to: "/dashboard/orders/$orderId", params: { orderId } })}
